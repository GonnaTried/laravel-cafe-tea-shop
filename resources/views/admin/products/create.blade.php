...
@section('content')
    <div class="container is-fluid">
        ...
        <h1 class="title is-4">Create New Product</h1>
        ...
        <div class="box">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        ...
                        @foreach ($itemOptions as $option)
                            @php
                                // Check if this option was previously selected (if validation failed)
                                $isChecked = old('selected_option_id') == $option->id;
                            @endphp
                    ...
                    @error('selected_option_id')
                        {{-- This error would fire if no option is selected --}}
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea @error('description') is-danger @enderror" name="description" id="description">{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea @error('ingredients') is-danger @enderror" name="ingredients" id="ingredients">{{ old('ingredients') }}</textarea>
                    </div>
                    @error('ingredients')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('price') is-danger @enderror" type="number" name="price"
                            id="price" value="{{ old('price') }}" required min="0" step="0.01">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('inventory') is-danger @enderror" type="number" name="inventory"
                            id="inventory" value="{{ old('inventory') }}" required min="0">
                    </div>
                    @error('inventory')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        {{-- Add an image element to display the preview --}}
                        <figure class="image is-128x128">
                            <img id="image-preview" src="{{ asset('images/placeholder.png') }}" alt="Image Preview">
                        </figure>
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            ...
            console.log('Script loaded for product create.');
                ...
                fileInput.onchange = () => {
                    ...
                    if (fileInput.files.length > 0) {
                        ...
                        if (selectedFile.type.startsWith('image/')) {
                            ...
                            // If a non-image is selected, just show the placeholder
                        ...
                        imagePreview.src = "{{ asset('images/placeholder.png') }}"; // Reset to placeholder
                    }
                }
            } else {
